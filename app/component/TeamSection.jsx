                    ...
                    <div key={index} className={styles.teamCard}>
                        ...
                        <div className={styles.socialIcons}>
                            <a href={member.social.facebook} target="_blank" rel="noopener noreferrer">
                                <FontAwesomeIcon icon={faFacebook} className={styles.icons_size} />
                            </a>
                            <a href={member.social.linkedin} target="_blank" rel="noopener noreferrer">
                                <FontAwesomeIcon icon={faLinkedin}  className={styles.icons_size}  />
                            </a>
                            <a href={member.social.behance} target="_blank" rel="noopener noreferrer">
                                <FontAwesomeIcon icon={faBehance}  className={styles.icons_size}  />
                            </a>
                            <a href={member.social.instagram} target="_blank" rel="noopener noreferrer">
                                <FontAwesomeIcon icon={faInstagram}  className={styles.icons_size}  />
                            </a>
                        </div>
                    </div>
                ))}
