    ...
    return (
        <div className={styles.lp_why_den_section}>
            <div className={styles.lp_why_den_section_text}>
                ...
                <p>
                    DEN is committed to providing top-notch educational resources and mentorship <br /> programs to help individuals achieve their full potential in the digital era.
                </p>
            </div>
            <div className={styles.lp_why_den_section_main_container}>
                <div className={styles.lp_why_den_section_container}>
                    <Image src={"/images/profile-icon.png"} width={70} height={100} alt="One on One Monitor" />
                ...
                <div className={styles.lp_why_den_section_container}>
                    <Image src={"/images/watch-icon.png"} width={70} height={100}  alt="24/7 Mentor" />
                    <h4>24/7 Mentor</h4>
                    <p>
                ...
                <div className={styles.lp_why_den_section_container}>
                    <Image src={"/images/grad-hat-icon.png"} width={70} height={100}  alt="Alumni Network" />
                ...
                <div className={styles.lp_why_den_section_container}>
                    <Image src={"/images/heart-icon.png"} width={70} height={100}  alt="Annual Experts" />
